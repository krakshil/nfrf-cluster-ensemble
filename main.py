...
ensemble_model = ClusterEnsemble(train_docs=train_docs, test_docs=test_docs, members_dir=save_dir_en, alpha_1_min = 0.65, alpha_2=0.5, save_dir=os.path.join("data","results"))
