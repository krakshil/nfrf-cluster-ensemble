...
# save_dir = "data"
save_dir = os.path.join("data","results","cluster_ensemble", "final", "v7")
...
ensemble_model.combine_partial_membership_matrix(ver=7, n_threshold=150, load=False)
print("\n\n")
total_clusters = 0
...
ensemble_model.consensus_fn(ver=7, load=False)


topic_model = topicModel(train_docs=train_docs, test_docs=test_docs, embedding_config=embedding_config, clustering_config=clustering_config, vectorizer_config=vectorizer_config, ctfidf_config=ctfidf_config, representation_config=representation_config, ver=7, save_dir=save_dir)
